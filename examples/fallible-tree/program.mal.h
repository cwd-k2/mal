...
typedef mal_repr_sum_1_t mal_NodeResult_t;
...
static inline mal_repr_sum_1_t mal_detail_to_host_1(mal_call_t *call, MalRepr_Sum_1 value) {
    switch (value.tag) {
        case UINT32_C(0): {
            return (mal_repr_sum_1_t){ .tag = UINT32_C(0), .payload.variant_0 = (mal_Ptr_t)value.payload.variant_0.address };
        }
        case UINT32_C(1): {
...
static inline MalRepr_Sum_1 mal_detail_to_raw_1(mal_call_t *call, mal_repr_sum_1_t value) {
    switch (value.tag) {
        case UINT32_C(0): {
            return (MalRepr_Sum_1){ .tag = UINT32_C(0), .payload.variant_0 = (MalType_Ptr){ .address = (uint8_t *)value.payload.variant_0 } };
        }
        case UINT32_C(1): {
...
static inline mal_repr_sum_1_t mal_repr_sum_1_make_0(mal_Ptr_t value) {
    return (mal_repr_sum_1_t){ .tag = mal_repr_sum_1_tag_0, .payload.variant_0 = value };
}

static inline MalRepr_Sum_1 mal_repr_sum_1_return_0(mal_call_t *call, mal_Ptr_t value) {
...
static inline MalRepr_Product_2 mal_repr_product_2_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_2_t value) {
    return (MalRepr_Product_2){ .field_0 = (MalType_Allocator){ .bits = value.field_0.mal_detail_bits }, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.field_1 } };
}
...
static inline mal_NodeResult_t mal_NodeResult_make_0(mal_Ptr_t value) {
    return (mal_NodeResult_t){ .tag = mal_NodeResult_tag_0, .payload.variant_0 = value };
}

static inline MalType_NodeResult mal_NodeResult_return_0(mal_call_t *call, mal_Ptr_t value) {
    return mal_detail_to_raw_1(call, (mal_NodeResult_t){ .tag = mal_NodeResult_tag_0, .payload.variant_0 = value });
}

#define mal_NodeResult_tag_1 UINT32_C(1)
static inline mal_NodeResult_t mal_NodeResult_make_1(void) {
    return (mal_NodeResult_t){ .tag = mal_NodeResult_tag_1, .payload.variant_1 = (mal_Unit_t){ 0 } };
}

static inline MalType_NodeResult mal_NodeResult_return_1(mal_call_t *call) {
    return mal_detail_to_raw_1(call, (mal_NodeResult_t){ .tag = mal_NodeResult_tag_1, .payload.variant_1 = (mal_Unit_t){ 0 } });
}
...
static MalType_Allocator mal_detail_createAllocator(mal_call_t *call, mal_UInt64_t value); \
MalType_Allocator mal_ext_createAllocator(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_UInt64 value) { \
...
static MalType_NodeResult mal_detail_allocateNode(mal_call_t *call, mal_repr_product_0_t value); \
MalType_NodeResult mal_ext_allocateNode(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Allocator argument_0, MalType_UInt64 argument_1) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
...
static MalType_NodeResult mal_detail_allocateNode( \
    mal_call_t *call, \
...
void mal_ext_releaseNode(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Allocator argument_0, MalType_Ptr argument_1) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    mal_detail_releaseNode(&call, (mal_repr_product_2_t){ .field_0 = (mal_Allocator_t){ .mal_detail_bits = ((MalRepr_Product_2){ .field_0 = argument_0, .field_1 = argument_1 }).field_0.bits }, .field_1 = (mal_Ptr_t)((MalRepr_Product_2){ .field_0 = argument_0, .field_1 = argument_1 }).field_1.address }); \
} \
