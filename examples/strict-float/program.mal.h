...
int32_t mal_ext_inspect(MalContext *context, float argument_0, float argument_1, double argument_2, int64_t argument_3);

#define MAL_DEFINE_inspect(context, argument_0, argument_1, argument_2, argument_3) int32_t mal_ext_inspect(MalContext *context MAL_MAYBE_UNUSED, float argument_0, float argument_1, double argument_2, int64_t argument_3)
