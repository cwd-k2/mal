...
typedef MalRepr_Product_4 MalType_Input;
...
typedef MalRepr_Sum_9 MalType_TransferResult;
...
typedef mal_repr_product_4_t mal_Input_t;
...
typedef mal_repr_sum_9_t mal_TransferResult_t;
...
static inline mal_repr_sum_0_t mal_detail_to_host_0(mal_call_t *call, MalRepr_Sum_0 value) {
    switch (value.tag) {
        ...
        case UINT32_C(1): {
            return (mal_repr_sum_0_t){ .tag = UINT32_C(1), .payload.variant_1 = (mal_Ptr_t)value.payload.variant_1.address };
        }
        default: {
...
static inline MalRepr_Sum_0 mal_detail_to_raw_0(mal_call_t *call, mal_repr_sum_0_t value) {
    switch (value.tag) {
        ...
        case UINT32_C(1): {
            return (MalRepr_Sum_0){ .tag = UINT32_C(1), .payload.variant_1 = (MalType_Ptr){ .address = (uint8_t *)value.payload.variant_1 } };
        }
        default: {
            mal_call_trap(call, "invalid sum tag");
        }
...
static inline mal_repr_sum_0_t mal_repr_sum_0_make_1(mal_Ptr_t value) {
    return (mal_repr_sum_0_t){ .tag = mal_repr_sum_0_tag_1, .payload.variant_1 = value };
}

static inline MalRepr_Sum_0 mal_repr_sum_0_return_1(mal_call_t *call, mal_Ptr_t value) {
...
static inline mal_repr_sum_2_t mal_detail_to_host_2(mal_call_t *call, MalRepr_Sum_2 value) {
    switch (value.tag) {
        case UINT32_C(0): {
            return (mal_repr_sum_2_t){ .tag = UINT32_C(0), .payload.variant_0 = (mal_Ptr_t)value.payload.variant_0.address };
        }
        case UINT32_C(1): {
...
static inline MalRepr_Sum_2 mal_detail_to_raw_2(mal_call_t *call, mal_repr_sum_2_t value) {
    switch (value.tag) {
        case UINT32_C(0): {
            return (MalRepr_Sum_2){ .tag = UINT32_C(0), .payload.variant_0 = (MalType_Ptr){ .address = (uint8_t *)value.payload.variant_0 } };
        }
        case UINT32_C(1): {
...
static inline mal_repr_sum_2_t mal_repr_sum_2_make_0(mal_Ptr_t value) {
    return (mal_repr_sum_2_t){ .tag = mal_repr_sum_2_tag_0, .payload.variant_0 = value };
}

static inline MalRepr_Sum_2 mal_repr_sum_2_return_0(mal_call_t *call, mal_Ptr_t value) {
...
static inline MalRepr_Product_3 mal_repr_product_3_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_3_t value) {
    return (MalRepr_Product_3){ .field_0 = (MalType_Ptr){ .address = (uint8_t *)value.field_0 }, .field_1 = value.field_1, .field_2 = value.field_2, .field_3 = value.field_3 };
}
...
static inline MalRepr_Product_4 mal_repr_product_4_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_4_t value) {
    return (MalRepr_Product_4){ .field_0 = (MalType_Ptr){ .address = (uint8_t *)value.field_0 }, .field_1 = value.field_1 };
}
...
static inline MalRepr_Product_6 mal_repr_product_6_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_6_t value) {
    return (MalRepr_Product_6){ .field_0 = value.field_0, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.field_1 }, .field_2 = value.field_2, .field_3 = value.field_3 };
}
...
static inline MalRepr_Product_10 mal_repr_product_10_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_10_t value) {
    return (MalRepr_Product_10){ .field_0 = value.field_0, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.field_1 }, .field_2 = value.field_2 };
}
...
static inline mal_MapAddress_t mal_MapAddress_make_1(mal_Ptr_t value) {
    return (mal_MapAddress_t){ .tag = mal_MapAddress_tag_1, .payload.variant_1 = value };
}

static inline MalType_MapAddress mal_MapAddress_return_1(mal_call_t *call, mal_Ptr_t value) {
...
static inline mal_PointerResult_t mal_PointerResult_make_0(mal_Ptr_t value) {
    return (mal_PointerResult_t){ .tag = mal_PointerResult_tag_0, .payload.variant_0 = value };
}

static inline MalType_PointerResult mal_PointerResult_return_0(mal_call_t *call, mal_Ptr_t value) {
...
static inline mal_TransferResult_t mal_TransferResult_make_0(mal_UInt64_t value) {
    return (mal_TransferResult_t){ .tag = mal_TransferResult_tag_0, .payload.variant_0 = value };
}

static inline MalType_TransferResult mal_TransferResult_return_0(mal_call_t *call, mal_UInt64_t value) {
    return mal_detail_to_raw_9(call, (mal_TransferResult_t){ .tag = mal_TransferResult_tag_0, .payload.variant_0 = value });
}
...
static inline MalType_TransferResult mal_TransferResult_return_1(mal_call_t *call, mal_UInt32_t value) {
    return mal_detail_to_raw_9(call, (mal_TransferResult_t){ .tag = mal_TransferResult_tag_1, .payload.variant_1 = value });
}
...
MalType_PointerResult mal_ext_systemMmap(MalContext *context, MalType_MapAddress argument_0, MalType_UInt64 argument_1, MalType_Int32 argument_2, MalType_Int32 argument_3, MalType_Int32 argument_4, MalType_UInt64 argument_5);
MalType_PointerResult mal_ext_systemMremap(MalContext *context, MalType_Ptr argument_0, MalType_UInt64 argument_1, MalType_UInt64 argument_2, MalType_Int32 argument_3);
MalType_Status mal_ext_systemMunmap(MalContext *context, MalType_Ptr argument_0, MalType_UInt64 argument_1);
MalType_DescriptorResult mal_ext_systemOpenat(MalContext *context, MalType_Int32 argument_0, MalType_Ptr argument_1, MalType_Int32 argument_2, MalType_UInt32 argument_3);
...
MalType_TransferResult mal_ext_systemRead(MalContext *context, MalType_Int32 argument_0, MalType_Ptr argument_1, MalType_UInt64 argument_2);
MalType_TransferResult mal_ext_systemWrite(MalContext *context, MalType_Int32 argument_0, MalType_Ptr argument_1, MalType_UInt64 argument_2);
...
MalType_PointerResult mal_ext_systemMmap(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_MapAddress argument_0, MalType_UInt64 argument_1, MalType_Int32 argument_2, MalType_Int32 argument_3, MalType_Int32 argument_4, MalType_UInt64 argument_5) { \
...
MalType_PointerResult mal_ext_systemMremap(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Ptr argument_0, MalType_UInt64 argument_1, MalType_UInt64 argument_2, MalType_Int32 argument_3) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_systemMremap(&call, (mal_ResizeRequest_t){ .field_0 = (mal_Ptr_t)((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_0.address, .field_1 = ((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_1, .field_2 = ((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_2, .field_3 = ((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_3 }); \
} \
...
MalType_Status mal_ext_systemMunmap(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Ptr argument_0, MalType_UInt64 argument_1) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_systemMunmap(&call, (mal_repr_product_4_t){ .field_0 = (mal_Ptr_t)((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1 }).field_0.address, .field_1 = ((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1 }).field_1 }); \
} \
...
MalType_DescriptorResult mal_ext_systemOpenat(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Int32 argument_0, MalType_Ptr argument_1, MalType_Int32 argument_2, MalType_UInt32 argument_3) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_systemOpenat(&call, (mal_repr_product_6_t){ .field_0 = ((MalRepr_Product_6){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_0, .field_1 = (mal_Ptr_t)((MalRepr_Product_6){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_1.address, .field_2 = ((MalRepr_Product_6){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_2, .field_3 = ((MalRepr_Product_6){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_3 }); \
} \
...
MalType_TransferResult mal_ext_systemRead(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Int32 argument_0, MalType_Ptr argument_1, MalType_UInt64 argument_2) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_systemRead(&call, (mal_repr_product_10_t){ .field_0 = ((MalRepr_Product_10){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_0, .field_1 = (mal_Ptr_t)((MalRepr_Product_10){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_1.address, .field_2 = ((MalRepr_Product_10){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_2 }); \
} \
...
MalType_TransferResult mal_ext_systemWrite(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Int32 argument_0, MalType_Ptr argument_1, MalType_UInt64 argument_2) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_systemWrite(&call, (mal_repr_product_10_t){ .field_0 = ((MalRepr_Product_10){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_0, .field_1 = (mal_Ptr_t)((MalRepr_Product_10){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_1.address, .field_2 = ((MalRepr_Product_10){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_2 }); \
} \
