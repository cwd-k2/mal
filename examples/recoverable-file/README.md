...
```nu
nix develop --command cargo run --manifest-path compiler/Cargo.toml -- build examples/recoverable-file/program.mal --output /tmp/mal-recoverable-file --link examples/recoverable-file/host.c
