...
static inline MalRepr_Product_1 mal_repr_product_1_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_1_t value) {
    return (MalRepr_Product_1){ .field_0 = (MalType_Allocation){ .bits = value.field_0.mal_detail_bits }, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.field_1 }, .field_2 = value.field_2, .field_3 = value.field_3 };
}

static inline mal_repr_sum_2_t mal_detail_to_host_2(mal_call_t *call, MalRepr_Sum_2 value) {
    switch (value.tag) {
        case UINT32_C(0): {
            return (mal_repr_sum_2_t){ .tag = UINT32_C(0), .payload.variant_0 = (mal_repr_product_1_t){ .field_0 = (mal_Allocation_t){ .mal_detail_bits = value.payload.variant_0.field_0.bits }, .field_1 = (mal_Ptr_t)value.payload.variant_0.field_1.address, .field_2 = value.payload.variant_0.field_2, .field_3 = value.payload.variant_0.field_3 } };
        }
        case UINT32_C(1): {
...
static inline MalRepr_Sum_2 mal_detail_to_raw_2(mal_call_t *call, mal_repr_sum_2_t value) {
    switch (value.tag) {
        case UINT32_C(0): {
            return (MalRepr_Sum_2){ .tag = UINT32_C(0), .payload.variant_0 = (MalRepr_Product_1){ .field_0 = (MalType_Allocation){ .bits = value.payload.variant_0.field_0.mal_detail_bits }, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.payload.variant_0.field_1 }, .field_2 = value.payload.variant_0.field_2, .field_3 = value.payload.variant_0.field_3 } };
        }
        case UINT32_C(1): {
...
static inline MalRepr_Product_3 mal_repr_product_3_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_3_t value) {
    return (MalRepr_Product_3){ .field_0 = (MalRepr_Product_1){ .field_0 = (MalType_Allocation){ .bits = value.field_0.field_0.mal_detail_bits }, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.field_0.field_1 }, .field_2 = value.field_0.field_2, .field_3 = value.field_0.field_3 }, .field_1 = value.field_1 };
}
...
static inline MalRepr_Product_4 mal_repr_product_4_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_4_t value) {
    return (MalRepr_Product_4){ .field_0 = (MalType_Allocation){ .bits = value.field_0.mal_detail_bits }, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.field_1 }, .field_2 = value.field_2 };
}
...
static inline MalRepr_Product_5 mal_repr_product_5_return(mal_call_t *call MAL_DETAIL_MAYBE_UNUSED, mal_repr_product_5_t value) {
    return (MalRepr_Product_5){ .field_0 = (MalType_Allocation){ .bits = value.field_0.mal_detail_bits }, .field_1 = (MalType_Ptr){ .address = (uint8_t *)value.field_1 } };
}
...
MalType_BufferResult mal_ext_allocateBuffer(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_UInt64 argument_0, MalType_UInt64 argument_1) { \
...
MalType_BufferResult mal_ext_resizeBuffer(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Buffer argument_0, MalType_UInt64 argument_1) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_resizeBuffer(&call, (mal_repr_product_3_t){ .field_0 = (mal_repr_product_1_t){ .field_0 = (mal_Allocation_t){ .mal_detail_bits = ((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1 }).field_0.field_0.bits }, .field_1 = (mal_Ptr_t)((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1 }).field_0.field_1.address, .field_2 = ((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1 }).field_0.field_2, .field_3 = ((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1 }).field_0.field_3 }, .field_1 = ((MalRepr_Product_3){ .field_0 = argument_0, .field_1 = argument_1 }).field_1 }); \
} \
...
MalType_Bool mal_ext_isCurrentBuffer(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Allocation argument_0, MalType_Ptr argument_1, MalType_UInt64 argument_2, MalType_UInt64 argument_3) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_isCurrentBuffer(&call, (mal_Buffer_t){ .field_0 = (mal_Allocation_t){ .mal_detail_bits = ((MalRepr_Product_1){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_0.bits }, .field_1 = (mal_Ptr_t)((MalRepr_Product_1){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_1.address, .field_2 = ((MalRepr_Product_1){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_2, .field_3 = ((MalRepr_Product_1){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2, .field_3 = argument_3 }).field_3 }); \
} \
...
MalType_Bool mal_ext_isCurrentSlice(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Allocation argument_0, MalType_Ptr argument_1, MalType_UInt64 argument_2) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    return mal_detail_isCurrentSlice(&call, (mal_Slice_t){ .field_0 = (mal_Allocation_t){ .mal_detail_bits = ((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_0.bits }, .field_1 = (mal_Ptr_t)((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_1.address, .field_2 = ((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_2 }); \
} \
...
void mal_ext_writeSlice(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Allocation argument_0, MalType_Ptr argument_1, MalType_UInt64 argument_2) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    mal_detail_writeSlice(&call, (mal_Slice_t){ .field_0 = (mal_Allocation_t){ .mal_detail_bits = ((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_0.bits }, .field_1 = (mal_Ptr_t)((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_1.address, .field_2 = ((MalRepr_Product_4){ .field_0 = argument_0, .field_1 = argument_1, .field_2 = argument_2 }).field_2 }); \
} \
...
void mal_ext_writeSliceDescriptor(MalContext *context MAL_DETAIL_MAYBE_UNUSED, MalType_Allocation argument_0, MalType_Ptr argument_1) { \
    mal_call_t call = (mal_call_t){ .mal_detail_context = context }; \
    mal_detail_writeSliceDescriptor(&call, (mal_repr_product_5_t){ .field_0 = (mal_Allocation_t){ .mal_detail_bits = ((MalRepr_Product_5){ .field_0 = argument_0, .field_1 = argument_1 }).field_0.bits }, .field_1 = (mal_Ptr_t)((MalRepr_Product_5){ .field_0 = argument_0, .field_1 = argument_1 }).field_1.address }); \
} \
