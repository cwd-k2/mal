...
```nu
nix develop --command cargo run -p mal-compiler -- check examples/numeric-conversion/program.mal
nix develop --command cargo run -p mal-compiler -- build examples/numeric-conversion/program.mal --output /tmp/mal-numeric-conversion
