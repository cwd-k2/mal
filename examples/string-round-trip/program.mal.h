...
#define MAL_DEFINE_receive(context) MalString mal_ext_receive(MalContext *context MAL_MAYBE_UNUSED)
#define MAL_DEFINE_send(context, value) void mal_ext_send(MalContext *context MAL_MAYBE_UNUSED, MalString value)
