...
| `backend/llvm` | admission済みexecution planをtarget tripleとdata layoutを持つLLVM moduleおよびC shimへ変換。現在はcapture、extern、managed value、recursive frameを持たない`Int32`演算、比較branch、direct call、self-tail edgeをadmit |
