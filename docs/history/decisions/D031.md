...
- Status: Accepted; memory operation spelling superseded by D037
- Date: 2026-09-06
...
runtime生成Symbolとclosure environmentを型ごとのownership operationで回収する。この方式もsource semanticsにはしない。
...
source semanticsへ追加せずに現在のownership実装と将来の別方式を両立できる。[D033](D033.md)
