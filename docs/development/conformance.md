...
| [`execution`: trap](../spec/execution.md#trap) | trapを生じる各規則のfocused test | shift、division/remainder、Symbol byte access、allocation、float conversion trap（`compiler/tests/c_emit.rs`） |
