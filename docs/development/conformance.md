...
| [program](../spec/programs.md) | generic top-level initializer、source order、entry signature、zero argument buffer | `Buffer<(Address, USize)>` process entryを実際のargvで実行 |
