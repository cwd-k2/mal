...
| control functionとportの試験設計を読む | [明示的control functionとport](design/cps-control.md) | [最小性](design/minimality.md)、[application control lowering](development/application-control-lowering.md) |
