...
use self::ast::{
    ...
    LOAD_PTR_VALUE, LOAD_STRING_VALUE, LOAD_UINT8_VALUE, LOAD_UINT16_VALUE, LOAD_UINT32_VALUE,
    LOAD_UINT64_VALUE, LambdaId, OFFSET_VALUE, PTR_TYPE, Program, STORE_FLOAT32_VALUE,
    ...
    STORE_UINT64_VALUE, STRING_TYPE, TRUE_VALUE, TypeBinding, TypeId, TypeReference, UINT8_TYPE,
