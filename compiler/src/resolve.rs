...
use self::ast::{
    ...
    LOAD_INT16_VALUE, LOAD_INT32_VALUE, LOAD_INT64_VALUE, LOAD_PTR_VALUE, LOAD_STRING_VALUE,
    ...
    STORE_INT16_VALUE, STORE_INT32_VALUE, STORE_INT64_VALUE, STORE_PTR_VALUE, STORE_STRING_VALUE,
...
pub const PREDEFINED_VALUES: &[(&str, ValueId)] = &[
    ...
    ("loadString", LOAD_STRING_VALUE),
    ("storeString", STORE_STRING_VALUE),
];
