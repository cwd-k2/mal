...
pub const OFFSET_VALUE: ValueId = ValueId(2);
pub const LOAD_INT64_VALUE: ValueId = ValueId(3);
pub const STORE_INT64_VALUE: ValueId = ValueId(4);
pub const LOAD_UINT8_VALUE: ValueId = ValueId(5);
pub const STORE_UINT8_VALUE: ValueId = ValueId(6);
pub const LOAD_INT8_VALUE: ValueId = ValueId(7);
pub const STORE_INT8_VALUE: ValueId = ValueId(8);
pub const LOAD_INT16_VALUE: ValueId = ValueId(9);
pub const STORE_INT16_VALUE: ValueId = ValueId(10);
pub const LOAD_INT32_VALUE: ValueId = ValueId(11);
pub const STORE_INT32_VALUE: ValueId = ValueId(12);
pub const LOAD_UINT16_VALUE: ValueId = ValueId(13);
pub const STORE_UINT16_VALUE: ValueId = ValueId(14);
pub const LOAD_UINT32_VALUE: ValueId = ValueId(15);
pub const STORE_UINT32_VALUE: ValueId = ValueId(16);
pub const LOAD_UINT64_VALUE: ValueId = ValueId(17);
pub const STORE_UINT64_VALUE: ValueId = ValueId(18);
pub const LOAD_FLOAT32_VALUE: ValueId = ValueId(19);
pub const STORE_FLOAT32_VALUE: ValueId = ValueId(20);
pub const LOAD_FLOAT64_VALUE: ValueId = ValueId(21);
