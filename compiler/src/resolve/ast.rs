...
pub const LOAD_INT8_VALUE: ValueId = ValueId(9);
pub const STORE_INT8_VALUE: ValueId = ValueId(10);
pub const LOAD_INT16_VALUE: ValueId = ValueId(11);
pub const STORE_INT16_VALUE: ValueId = ValueId(12);
pub const LOAD_INT32_VALUE: ValueId = ValueId(13);
pub const STORE_INT32_VALUE: ValueId = ValueId(14);
pub const LOAD_UINT16_VALUE: ValueId = ValueId(15);
pub const STORE_UINT16_VALUE: ValueId = ValueId(16);
pub const LOAD_UINT32_VALUE: ValueId = ValueId(17);
pub const STORE_UINT32_VALUE: ValueId = ValueId(18);
pub const LOAD_UINT64_VALUE: ValueId = ValueId(19);
pub const STORE_UINT64_VALUE: ValueId = ValueId(20);
pub const LOAD_FLOAT32_VALUE: ValueId = ValueId(21);
